<%@ page language="java" import="java.util.*,com.ascent.bean.*" contentType="text/html;charset=gb2312" errorPage="./error.jsp"%>
<%
										...
										<table class="mars" cellspacing="1" cellpadding="0"
											...
											<tbody>
												...
												<tr bgcolor="#f3f3f3">
													...
													<td>
														<div align="center">
															<a href="./order?a=lookuse&uid=<%=od.getId()%>"><%=od.getId()%></a>
														</div>
													</td>
													<td>
														<div align="center">
