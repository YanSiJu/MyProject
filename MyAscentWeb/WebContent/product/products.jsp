<%@ page language="java" import="com.ascent.bean.Usr"
				...
				<form name="form" method="post" action="./login?a=login">
					<div class="small box">
							...
							<tr>
								...
								<td align="left" valign="bottom">
									<a href="#"> <input name="image" type="image"
											...
											src="./images/login_1_7.jpg" alt="登录" width="44" height="17"
											border="0" /> </a>
								</td>
							</tr>
							<tr>
						...
						<table width="150" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td height="30" valign="bottom">
									<span class="big_k"> <a href="./login?a=out">注销</a> </span>
								</td>
								<%
