					...
					<tr>
						...
						<td height="15" align="left" valign="top" class="12">
							...
							<table width="100%" border="1" cellspacing="0" cellpadding="0"
								...
								<%
									List<Product> list = (ArrayList) request.getAttribute("searchproductlist");
									for (Product pu : list) {
										int id = pu.getId();
								%>
								<tr bgcolor="#f3f3f3" height="25">
									...
									<td width="12%">
										<div align="center">
											<img src="<%=request.getContextPath() + "/upload/23007.gif"%>"
									...
									<td width="13%">
										<div align="center">
											<button onclick="return addshop(<%=id%>)">购买</button>
										</div>
									</td>
								</tr>
								<%
