...
public class QuicklySortTest {
	...
	public void quicklySortTest() {
		...
		System.out.println("quicklySortTest");
...
//		System.out.println("quicklySort  time:" + (end - start));
		...
		/*
		 * start = System.currentTimeMillis(); sort.insetrSort(a); end =
		 * System.currentTimeMillis(); System.out.println("insetrSort  time:" +
		 * (end - start));
		 */

		/*
		 * System.out.println("����ǰ:" + Arrays.toString(a));
		 * sort.quicklySort(a, 0, a.length - 1); // sort.median(a, 0, a.length -
