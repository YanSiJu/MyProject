...
public class MiniDrawPad extends JFrame{
	...
	private String tipText[] = {
			...
			// 读者可以参照上面的按钮定义对照着理解
			"Draw a new picture", "Open a saved picture", "Save current drawing", "Draw at will",
			"Draw a straight line", "Draw a rectangle", "Fill a ractangle", "Draw an oval", "Fill an oval",
			"Draw a circle", "Fill a circle", "Draw a round rectangle", "Fill a round rectangle", "Erase at will",
			"Choose current drawing color", "Set current drawing stroke", "Write down what u want" };
	...
	class DrawPanel extends JPanel {
		...
		void draw(Graphics g, drawings i) {
			i.draw(g);// 将画笔传入到各个子类中，用来完成各自的绘图
		}
	}
